...
public class ApIncomingService {
    ...
    private ConsignmentIdentifiersDTO parseBodyToIdentifiers(final NotificationContentDto notificationContent) {
        return serializeUtils.mapXmlStringToClass(notificationContent.getBody(), ConsignmentIdentifiersDTO.class);
    }

...
public class IdentifiersRequestBodyDto {
    ...
    public static IdentifiersRequestBodyDto fromControl(final ControlDto controlDto){
        final SearchParameter transportIdentifiers = controlDto.getTransportIdentifiers();
        ...
        if (transportIdentifiers != null){
            identifiersRequestBodyDto.setVehicleID(transportIdentifiers.getVehicleId());
            identifiersRequestBodyDto.setTransportMode(transportIdentifiers.getTransportMode());
            identifiersRequestBodyDto.setIsDangerousGoods(transportIdentifiers.getIsDangerousGoods());
            identifiersRequestBodyDto.setVehicleCountry(transportIdentifiers.getVehicleCountry());
        }

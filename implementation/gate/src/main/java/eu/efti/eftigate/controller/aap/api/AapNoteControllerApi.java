...
public interface AapNoteControllerApi {
    ...
    @Operation(summary = "AAP get a follow up communication status", description = "AAP get the processing status of a follow up communication for a given note request id")
    @ApiResponses(value = {
    ...
    @GetMapping("/aap/control/uil/follow-up")
    @Secured(Roles.ROLE_EXT_AAP)

...
class IdentifiersControllerTest {
    ...
    void requestIdentifiersTest() throws Exception {
        final ConsignmentIdentifiersRequestDto consignmentIdentifiersRequestDto = ConsignmentIdentifiersRequestDto.builder().vehicleID("abc123").build();

        Mockito.when(controlService.createIdentifiersControl(consignmentIdentifiersRequestDto)).thenReturn(
        ...
        String result = mockMvc.perform(post("/v1/getIdentifiers")
                        ...
                        .content(new ObjectMapper().writeValueAsBytes(consignmentIdentifiersRequestDto)))

...
class ApIncomingServiceTest extends AbstractTest {
    ...
    @Test
    void manageIncomingNotificationUilResponse() throws IOException, InterruptedException {
        final String body = """
                    <uilResponse
    ...
    @Test
    void manageIncomingNotificationIdentifierResponse() throws IOException, InterruptedException {
        final String body = """
                    <identifierResponse
                                xmlns="http://efti.eu/v1/edelivery"
                                xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
    ...
    @Test
    void manageIncomingNotificationPostFollowUpRequest() throws IOException, InterruptedException {
        final String body = """
                    <postFollowUpRequest
    ...
    @Test
    void manageIncomingNotificationIdentifierQuery() throws IOException, InterruptedException {
        final String body = """

package eu.efti.identifierregistry.config;
...
@EnableJpaRepositories(
        basePackages = {"eu.efti.identifierregistry.repository"},
...
public class IdentifiersJpaConfiguration {
    ...
    public SpringLiquibase identifiersDataSourceLiquibase(
            ...
            @Qualifier("identifiersLiquibaseProperties") LiquibaseProperties identifiersLiquibaseProperties) {
    ...
    public PlatformTransactionManager identifiersTransactionManager(
            @Qualifier("identifiersEntityManagerFactory") final LocalContainerEntityManagerFactoryBean identifiersEntityManagerFactory) {
        return new JpaTransactionManager(Objects.requireNonNull(identifiersEntityManagerFactory.getObject()));
    }

...
--  *********************************************************************
--  Change Log: src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml
--  Ran at: 8/11/26, 12:29 PM
--  Against: null@offline:mysql?changeLogFile=target/liquibase/changelog-1.19.mysql
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7836::gautifr
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-4740::idragusa
--  Plugin specific tables
CREATE TABLE WS_PLUGIN_TB_MESSAGE_LOG (ID_PK BIGINT AUTO_INCREMENT NOT NULL, MESSAGE_ID VARCHAR(255) NOT NULL, MESSAGE_ENTITY_ID BIGINT NULL, CONVERSATION_ID VARCHAR(255) NULL, REF_TO_MESSAGE_ID VARCHAR(255) NULL, FROM_PARTY_ID VARCHAR(255) NULL, FINAL_RECIPIENT VARCHAR(255) NULL, ORIGINAL_SENDER VARCHAR(255) NULL, RECEIVED timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CONSTRAINT PK_WS_PLUGIN_TB_MESSAGE_LOG PRIMARY KEY (ID_PK));

ALTER TABLE WS_PLUGIN_TB_MESSAGE_LOG ADD CONSTRAINT UK_WS_MESSAGE_ID UNIQUE (MESSAGE_ID);

--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-2427::Francois Gautier
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7803-Dictionary Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7803-UserMessage Tables::Cosmin Baciu
...
CREATE TABLE TB_USER_MESSAGE_LOG (ID_PK BIGINT NOT NULL, BACKEND VARCHAR(255) NULL, RECEIVED timestamp NOT NULL, ACKNOWLEDGED timestamp NULL, DOWNLOADED timestamp NULL, ARCHIVED timestamp NULL, EXPORTED timestamp NULL, FAILED timestamp NULL, RESTORED timestamp NULL, DELETED timestamp NULL, NEXT_ATTEMPT timestamp NULL, FK_TIMEZONE_OFFSET BIGINT NULL, SEND_ATTEMPTS INT NULL, SEND_ATTEMPTS_MAX INT NULL, SCHEDULED timestamp NULL COMMENT 'the moment when the message was scheduled to be sent', VERSION INT DEFAULT 0 NOT NULL COMMENT 'Used for optimistic locking mechanism', MESSAGE_STATUS_ID_FK BIGINT NOT NULL, MSH_ROLE_ID_FK BIGINT NOT NULL, NOTIFICATION_STATUS_ID_FK BIGINT NULL, ASYNC_NOTIFICATION_OVERRIDE BIT(1) NULL, SECURITY_PROFILE VARCHAR(50) NULL, DYNAMIC_DISCOVERY_VALUE_SOURCE VARCHAR(255) NULL, CREATION_TIME timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CREATED_BY VARCHAR(255) DEFAULT 'DOMIBUS' NOT NULL, MODIFICATION_TIME timestamp NULL, MODIFIED_BY VARCHAR(255) NULL, PROCESSING_TYPE VARCHAR(255) NULL, AUTO_SEND_IF_COMPLETE BIT(1) DEFAULT 1 NOT NULL, CONSTRAINT PK_MESSAGE_LOG PRIMARY KEY (ID_PK));
...
CREATE INDEX IDX_UML_REC_IDPK ON TB_USER_MESSAGE_LOG(ID_PK, RECEIVED);

CREATE INDEX IDX_UML_STATUS_BACKEND ON TB_USER_MESSAGE_LOG(MESSAGE_STATUS_ID_FK, BACKEND, DELETED, EXPORTED, ID_PK);
...
CREATE INDEX IDX_MESSAGE_LOCK_PARTIAL_SEARCH ON TB_MESSAGING_LOCK(MPC, INITIATOR);
...
CREATE TABLE TB_PART_INFO (ID_PK BIGINT AUTO_INCREMENT NOT NULL, PAYLOAD_MANAGER_SPI VARCHAR(255) NULL, BINARY_DATA LONGBLOB NULL, DESCRIPTION_LANG VARCHAR(255) NULL, DESCRIPTION_VALUE VARCHAR(255) NULL, HREF VARCHAR(255) NULL, IN_BODY BIT(1) NULL, FILENAME VARCHAR(255) NULL, MIME VARCHAR(255) NOT NULL, USER_MESSAGE_ID_FK BIGINT NOT NULL, PART_ORDER INT DEFAULT 0 NOT NULL, ENCRYPTED BIT(1) DEFAULT 0 NULL, COMPRESSED BIT(1) DEFAULT 0 NULL, TYPE VARCHAR(50) NULL, PROCESSING_STATE VARCHAR(50) NULL, PROCESSING_DETAIL VARCHAR(1024) NULL, CREATION_TIME timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CREATED_BY VARCHAR(255) DEFAULT 'DOMIBUS' NOT NULL, MODIFICATION_TIME timestamp NULL, MODIFIED_BY VARCHAR(255) NULL, PART_LENGTH BIGINT DEFAULT -1 NOT NULL, CONSTRAINT PK_PART_INFO PRIMARY KEY (ID_PK));
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7803-Miscellaneous Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7803-PMode Tables::Cosmin Baciu
...
ALTER TABLE TB_PM_PARTY ADD CONSTRAINT UK_PM_PARTY_NAME UNIQUE (NAME);

CREATE TABLE TB_PM_CONFIGURATION (ID_PK BIGINT AUTO_INCREMENT NOT NULL, FK_BUSINESSPROCESSES BIGINT NULL, FK_PARTY BIGINT NULL, VERSION INT DEFAULT 0 NOT NULL COMMENT 'Used for optimistic locking mechanism', VERSION_SUPPORT VARCHAR(255) NULL COMMENT 'Used for optimistic locking mechanism', CREATION_TIME timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CREATED_BY VARCHAR(255) DEFAULT 'DOMIBUS' NOT NULL, MODIFICATION_TIME timestamp NULL, MODIFIED_BY VARCHAR(255) NULL, CONSTRAINT PK_PM_CONFIGURATION PRIMARY KEY (ID_PK));
...
ALTER TABLE TB_PM_JOIN_PROCESS_INIT_PARTY ADD CONSTRAINT FK_JOIN_INIT_PARTY FOREIGN KEY (PARTY_FK) REFERENCES TB_PM_PARTY (ID_PK) ON UPDATE RESTRICT ON DELETE CASCADE;
...
ALTER TABLE TB_PM_JOIN_PROCESS_RESP_PARTY ADD CONSTRAINT FK_JOIN_PROC_RESP_PARTY FOREIGN KEY (PARTY_FK) REFERENCES TB_PM_PARTY (ID_PK) ON UPDATE RESTRICT ON DELETE CASCADE;
...
CREATE TABLE TB_PM_PARTY_AUD (ID_PK BIGINT NOT NULL, REV BIGINT NOT NULL, REVTYPE TINYINT NULL, ENDPOINT VARCHAR(1024) NULL, ENDPOINT_MOD BIT(1) NULL, NAME VARCHAR(255) NULL, NAME_MOD BIT(1) NULL, PASSWORD VARCHAR(255) NULL, PASSWORD_MOD BIT(1) NULL, USERNAME VARCHAR(255) NULL, USERNAME_MOD BIT(1) NULL, IS_DYNAMIC BIT(1) NULL, ISDYNAMIC_MOD BIT(1) NULL, SECURITY_PROFILE VARCHAR(50) NULL, SECURITYPROFILE_MOD BIT(1) NULL, CONSTRAINT PK_PARTY_AUD PRIMARY KEY (ID_PK, REV));
...
ALTER TABLE TB_PM_PARTY_IDENTIFIER ADD CONSTRAINT FK_PARTY_IDENT_PARTY FOREIGN KEY (FK_PARTY) REFERENCES TB_PM_PARTY (ID_PK) ON UPDATE RESTRICT ON DELETE CASCADE;
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7803-Alert Tables::Cosmin Baciu
...
CREATE INDEX IDX_EVENT_TYPE_PROPERTY_VALUE ON TB_EVENT_PROPERTY(DTYPE, EVENT_TYPE, PROPERTY_TYPE, STRING_VALUE);

--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-8450::Francois Gautier
CREATE TABLE TB_EARCHIVE_BATCH (ID_PK BIGINT AUTO_INCREMENT NOT NULL, BATCH_ID VARCHAR(255) NULL, ORIGINAL_BATCH_ID VARCHAR(255) NULL COMMENT 'The original BATCH_ID from which this batch was generated/re-exported', REEXPORTED BIT(1) DEFAULT 0 NOT NULL COMMENT 'true if this batch messages were re-exported by a new batch', REQUEST_TYPE VARCHAR(255) NULL, BATCH_STATUS VARCHAR(255) NULL, DATE_REQUESTED timestamp NULL, DATE_DELETED timestamp NULL, LAST_PK_USER_MESSAGE BIGINT NULL, FIRST_PK_USER_MESSAGE BIGINT NULL, DOMIBUS_CODE VARCHAR(255) NULL, MESSAGE VARCHAR(255) NULL, MANIFEST_CHECK_SUM VARCHAR(255) NULL, BATCH_SIZE INT NULL, STORAGE_LOCATION VARCHAR(255) NULL, CREATION_TIME timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CREATED_BY VARCHAR(255) DEFAULT 'DOMIBUS' NOT NULL, MODIFICATION_TIME timestamp NULL, MODIFIED_BY VARCHAR(255) NULL, CONSTRAINT PK_EARCHIVE_BATCH PRIMARY KEY (ID_PK));
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7803-Backend Filter Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-7803-User/Plugin User Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-4669::dussath
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-8503_1::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-8532::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-9563::Razvan Cretu
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-9686::Lucian Furca
ALTER TABLE TB_PM_SECURITY ADD PROFILE VARCHAR(255) NULL;

--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-15856-sql::Breaz Ionut
CREATE TABLE TB_MESSAGES_TO_RESEND (ID_PK BIGINT AUTO_INCREMENT NOT NULL, MESSAGE_ENTITY_ID BIGINT NOT NULL, CREATION_TIME timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CREATED_BY VARCHAR(255) DEFAULT 'DOMIBUS' NOT NULL, MODIFICATION_TIME timestamp NULL, MODIFIED_BY VARCHAR(255) NULL, CONSTRAINT PK_MESSAGES_TO_RESEND_NEW PRIMARY KEY (ID_PK));

ALTER TABLE TB_MESSAGES_TO_RESEND ADD CONSTRAINT UK_MESSAGES_TO_RESEND_ENTITY_ID UNIQUE (MESSAGE_ENTITY_ID);

--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-12066::Cosmin Baciu
CREATE TABLE TB_DDC_LOOKUP (ID_PK BIGINT AUTO_INCREMENT NOT NULL, FINAL_RECIPIENT VARCHAR(255) NULL, ENDPOINT_URL VARCHAR(1000) NULL, PARTY_NAME VARCHAR(255) NOT NULL, PARTY_TYPE VARCHAR(255) NOT NULL, PARTY_PROCESSES VARCHAR(500) NOT NULL, CERT_ISSUER_SUBJECT VARCHAR(500) NOT NULL, CERT_CN VARCHAR(255) NOT NULL, CERT_SUBJECT VARCHAR(255) NOT NULL, CERT_SERIAL VARCHAR(255) NOT NULL, CERT_FINGERPRINT VARCHAR(255) NOT NULL, DDC_LOOKUP_TIME timestamp NULL, DYNAMIC_DISCOVERY_VALUE_SOURCE VARCHAR(255) NULL, CREATION_TIME timestamp DEFAULT (UTC_TIMESTAMP) NOT NULL, CREATED_BY VARCHAR(255) DEFAULT 'DOMIBUS' NOT NULL, MODIFICATION_TIME timestamp NULL, MODIFIED_BY VARCHAR(255) NULL, CONSTRAINT PK_DDC_CERTIFICATE PRIMARY KEY (ID_PK));

ALTER TABLE TB_DDC_LOOKUP ADD CONSTRAINT UK_DDC_FINAL_RECIPIENT_PARTY UNIQUE (FINAL_RECIPIENT, PARTY_NAME);
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::12066-1::Cosmin Baciu
CREATE INDEX IDX_DDC_FINAL_RECIPIENT ON TB_DDC_LOOKUP(FINAL_RECIPIENT);

--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-11796-add-pks-mysql::Gabriel Maier
...
--  Changeset src/main/resources/db/releases/5.2.1/5.2.1-changelog.xml::EDELIVERY-14185::perpeio
